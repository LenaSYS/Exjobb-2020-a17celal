  ...
  <body>
    <div class="navbar">
      ...
      <div class="paper">
        ...
        <div class="row">
            <a href="isor.php">
                <img class="dog" src="isor.jpg" alt="Puppy">
            </a>
            <a href="pandora.php">
                <img class="dog" src="pandora.jpg" alt="Puppy"> <br>
            </a>
            <a href="allie.php">
                <img class="dog" src="allie.jpg" alt="Puppy">
            </a>
            <a href="titus.php">
                <img class="dog" src="titus.jpg" alt="Puppy">
            </a>
        </div>
      </div>
  </body>
