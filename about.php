...
<body>
    <div class="navbar">
        ...
        <a class="active" id="aboutus" href="about.php">Om oss</a>
    ...
    <div class="paper">
        ...
        <p class="intro">
            ...
            Skälen till att hundarna hamnar på Hundjouren är många. Familjehunden som är på rymmen hamnar här efter att polisen har fångat in den.
            ...
            oavsett anledning skall få det så bra som möjligt utifrån hundens förutsättningar och få ett nytt kärleksfullt hem.
        </p>
