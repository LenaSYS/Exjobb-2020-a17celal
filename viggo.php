...
<body onload="loaded()">
    <div class="sidenav">
        ...
        <div class="dropdown-container">
            ...
            <a style="background-color: #f9bfe5;" id="viggo" href="viggo.php">Viggo</a>
    ...
    <div class="paper">
        ...
        <p class="description-text">
            ...
            glädjerus.
            Viggo tycker om att träna och samarbeta för belöning och skulle uppskatta någon form av lydnads- eller
            trixträning i sitt nya hem.
        </p>
    </div>
