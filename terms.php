...
<body onload="loaded()">
    ...
    <div class="paper">
        ...
        <ul>
            ...
            <li>Djur får inte placeras till ett nytt hem. Om djuret inte kan bo kvar ska hen återgå till Hundjouren. Djuret
                får ej avlivas utan att Hundjouren blivit kontaktade.</li>
            <li>Om du byter adress, telefonnummer, eller e-post ska du kontakta oss på Hundjouren så vi vet var vi kan nå dig.
            </li>
            <li>Missköts djuret eller om villkoren i kontraktet bryts, hävs kontraktet och djuret går direkt tillbaka till
                Hundjouren.</li>
